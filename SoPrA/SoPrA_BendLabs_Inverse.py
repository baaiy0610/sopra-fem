...
class OrientationSweepController(Sofa.Core.Controller):
   ...
   def __init__(self, *args, **kwargs):
        ...
        self.SurfacePressureEquality = kwargs["SurfacePressureEquality"]
        self.alpha = 0
        self.beta = 0
...
#        (alpha, beta) = calcAlphaAndBeta(self.RotationAngle, self.Height, self.RInXY)
        ...
        try:
            print("Path: ",self.LiveAngleDataPath)
...
#        
        ...
        self.SurfacePressureEquality.eqPressure = Pressure
...
#
                ...
                model.addObject('UniformMass', totalMass='0.009')
...
#                   
                ...
                PointsArray1 = np.array([
                           [10,17.2,-5],[19,13.4,-5],[21.5,9.7,-5],[24.2,0,-5],[21.5,-9.7,-5],[19,-13.4,-5],[10,-17.2,-5],
                           [10,17,-10],[19,13,-10],[21.5,9.5,-10],[24.4,0,-10],[21.5,-9.5,-10],[19,-13,-10],[10,-17,-10],
                           [10,16.8,-15],[19,12.6,-15],[21.5,8,-15],[24.2,0,-15],[21.5,-8,-15],[19,-12.6,-15],[10,-16.8,-15],
                           [10,16.5,-20],[19,12.2,-20],[21.5,8.5,-20],[24,0,-20],[21.5,-8.5,-20],[19,-12.2,-20],[10,-16.5,-20],
                           
                           [10,16.0,-30],[19,11.1,-30],[21.5,7.5,-30],[23.6,0,-30],[21.5,-7.5,-30],[19,-11.1,-30],[10,-16,-30],
                           
                           [10,15.7,-40],[19,10.9,-40],[21.5,6.8,-40],[23.2,0,-40],[21.5,-6.8,-40],[19,-10.9,-40],[10,-15.7,-40],
                           
                           [10,15.3,-50],[19,10.5,-50],[21.5,6,-50],[22.8,0,-50],[21.5,-6,-50],[19,-10.5,-50],[10,-15.3,-50],
                           
                           [10,15,-60],[19,10,-60],[21.5,5,-60],[22.5,0,-60],[21.5,-5,-60],[19,-10,-60],[10,-15,-60],
                           
                           [10,14.7,-70],[19,9.4,-70],[21.5,4.2,-70],[21.7,0,-70],[21.5,-4.2,-70],[19,-9.4,-70],[10,-14.7,-70],
                           
                           [10,14.4,-80],[19,8.9,-80],[21.5,3.5,-80],[21.4,0,-80],[21.5,-3.5,-80],[19,-8.9,-80],[10,-14.4,-80],
                           
                           [10,13.8,-90],[19,8.5,-90],[21.5,1.6,-90],[21,0,-90],[21.5,-1.6,-90],[19,-8.5,-90],[10,-13.8,-90],
                           [10,13.5,-95],[19,8,-95],[21.5,1,-95],[21,0,-95],[21.5,-1,-95],[19,-8,-95],[10,-13.5,-95],
                           [10,13.5,-100],[19,8,-100],[21.5,1,-100],[21,0,-100],[21.5,-1,-100],[19,-8,-100],[10,-13.5,-100],
                           [10,13.5,-105],[19,8,-105],[21.5,1,-105],[21,0,-105],[21.5,-0.5,-105],[19,-8,-105],[10,-13.5,-105],
                           [10,13.5,-110],[19,8,-110],[21.5,1,-110],[21,0,-110],[21.5,-1,-110],[19,-8,-110],[10,-13.5,-110],
                           ])
...
#                
                ...
                FPANode = RigidNode.addChild('FPANode')
                FPANode.addObject('MechanicalObject', template='Rigid3', position=[0,0,Const.Height,0,0,1,0])
                FPANode.addObject('ForcePointActuator', name='FPA1', template='Rigid3', direction='1 0 0 0 0 0', indices=0, maxForce=1000000, minForce=-1000000, showForce=True, visuScale=0.2) #, showDirection=True, showVisuScale=10)                
                FPANode.addObject('ForcePointActuator', name='FPA2', template='Rigid3', direction='0 1 0 0 0 0', indices=0, maxForce=1000000, minForce=-1000000, showForce=True, visuScale=0.2)                
                #FPANode.addObject('ForcePointActuator', name='FPA3', template='Rigid3', direction='0 0 1 0 0 0', indices=0, maxForce=100, minForce=-100, showForce=True, visuScale=20)                
                FPANode.addObject("IdentityMapping")
...
#                # Use force point actuators on the tip (rigid)
                SPANode = model.addChild('SPANode')
                SPE = None
                for i in range(1,2):
                    CurrentCavity = SPANode.addChild('Cavity0'+str(i))
                    ...
                    CurrentCavity.addObject('MechanicalObject', name='SPANode')
                    SPE = CurrentCavity.addObject('SurfacePressureEquality', template='Vec3', triangles='@topo.triangles', maxPressure='100', minPressure='0', drawPressure='1', drawScale='0.02')
                    CurrentCavity.addObject('BarycentricMapping', name='mapping',  mapForces=False, mapMasses=False)

                
                
                rootNode.addObject(OrientationSweepController(name="OrientationSweeController", BendLabsEffector=BLE, SurfacePressureEquality=SPE))
